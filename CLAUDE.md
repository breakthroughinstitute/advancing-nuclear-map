...
- **App**: `~/advancing-nuclear-map/index.html` — HTML + CSS + app JS (~89KB, edit this for UI/logic)
- **Scenario data**: `~/advancing-nuclear-map/scenario-data.js` — 616KB, WISdom aggregate data (SD, GD, NAT, ND, NAT_JOBS, STATE_INV, DISP, RETAIL, SYSCOST). Do not hand-edit.
- **Plant data**: `~/advancing-nuclear-map/data.js` — 3.3MB auto-generated by build_data.py, do not hand-edit
...
git add index.html scenario-data.js   # data.js only when data pipeline was run
git commit -m "..."
git push
```
